...
function calcBEM(params) {
  ...
  // A 3"x1.8" 2-blade yields ~0.1318 Ct and ~0.0636 Cp at hover. 
  // pitch/D = 0.6
  // base Ct multiplier = 0.1318 / 0.6 ≈ 0.2196
  // base Cp multiplier = 0.0636 / 0.6 ≈ 0.1060
  ...
  // Advance ratio logic (Thrust/Power drop off as we approach pitch speed)
  // Pitch speed J0 approximates pRatio
  const J0 = pRatio;
